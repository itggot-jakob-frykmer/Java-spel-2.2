...
public class MainMenu {
	...
	int logoX = Screen.panelWidth / 2 - logoWidth / 2; // centerar
	int logoY = 80;
	...
	public void initComponents() {
		...
		int buttonX = Screen.panelWidth / 2 - buttonWidth / 2;
		int buttonY = 500;
		...
		try {
			...
			int quitButtonX = (int) (Screen.panelWidth - buttonWidth * 1.05);
			int quitButtonY = (int) (Screen.panelHeight - buttonHeight * 1.5);
	...
	public void handleMouseMoved(MouseEvent e) {
		Rectangle mouseRect = new Rectangle(InputHandler.scaledOnScreenMouseX, InputHandler.scaledOnScreenMouseY, 1, 1);
	...
	public void paint(Graphics2D g2d) {
		g2d.drawImage(background, 0, 0, Screen.panelWidth, Screen.panelHeight, null);

		for (int i = 0; i < birds.size(); i++) {
			birds.get(i).paint(g2d);
		}
		g2d.drawImage(trees, 0, 0, Screen.panelWidth, Screen.panelHeight, null);
		...
		if (Main.States.inMainMenu == Main.state) {
			...
			Screen.paintText(Screen.panelWidth / 2, 500, Screen.standardFont, Font.BOLD, 80, "Loading" + dots, Color.BLACK, g2d, 100000, true);
		}
