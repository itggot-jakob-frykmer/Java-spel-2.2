...
public abstract class InteractableWorldObject extends WorldObject {
	...
	public void update() {
		...
		Rectangle unScaledobjectRect = getCollisionBox();

		Rectangle objectRect = new Rectangle(Screen.fixX((int) unScaledobjectRect.getX(), 1), Screen.fixY((int) unScaledobjectRect.getY(), 1), (int) unScaledobjectRect.getWidth(), (int) unScaledobjectRect.getHeight());
		...
		if (unScaledobjectRect.intersects(Main.clientPlayer.getCollisionBox())) {
			playerInReach = true;
